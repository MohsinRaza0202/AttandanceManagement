...
const AcceptedLeaveScreen = props => {
...
useEffect(() => {
  ...
  if (!Isrefreshing &&  AcceptedLeave.length === 0) {
    return (
      <View style={styles.centered}>
  ...
  return (
      <View style={styles.container}>
          <Text style={styles.containertext}>Accepted Leave</Text>
          <Text style={styles.Nametext}>{Name[0]}</Text>
          <FlatList
              onRefresh={LoadedAcceptedLeave}
...
export default AcceptedLeaveScreen;